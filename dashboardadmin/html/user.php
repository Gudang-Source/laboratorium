                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
											...
											<td width="133" align="center" valign="middle" bgcolor="#00FFFF"><a href="../html/datauser/tambah.php">TAMBAH</a></td>
                                        </tr>
                                    </thead>
                                 <?php
								...
								?>
									  <tr>
											...
											<td p align="center" bgcolor="#FFFFFF"><a href="../html/datauser/cobaedit.php ?ID=<?php echo $data['ID'];?>" title="Edit siswa ini"> || Edit || </a><a href="../html/datauser/cobadelete.php?ID=<?php echo $data['ID'];?>" onclick="return confirm('Yakin mau di hapus?');">|| Hapus ||</a>
											</td>
									  </tr>
								<?php
									}
