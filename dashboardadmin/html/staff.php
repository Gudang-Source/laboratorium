            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Data Staff</h4> </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive">
								...
								<?php
									error_reporting(0);
									$sql	= 'SELECT id, Nama, Alamat, no_telp, status FROM staff';
									$query	= mysqli_query($db_link,$sql);
								?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <td width="112" height="29" align="center" valign="middle" bgcolor="#ccc">ID_Staff</td>
											<td width="176" align="center" valign="middle" bgcolor="#ccc">Nama</td>
											<td width="252" align="center" valign="middle" bgcolor="#ccc">Alamat</td>
											<td width="134" align="center" valign="middle" bgcolor="#ccc">No Telp</td>
											<td width="134" align="center" valign="middle" bgcolor="#ccc">Status</td>
											<td width="133" align="center" valign="middle" bgcolor="#ccc"><a href="../html/datastaf/tambah.php">TAMBAH</a></td>
                                        </tr>
                                    </thead>
                                 <?php
								...
								?>
									  <tr>
											...
											<td p align="center" bgcolor="#FFFFFF"><a href="../html/datastaf/cobaedit.php ?id=<?php echo $data['id'];?>" title="Edit siswa ini"> || Edit || </a><a href="../html/datastaf/cobadelete.php?id=<?php echo $data['id'];?>" onclick="return confirm('Yakin mau di hapus?');">|| Hapus ||</a>
											</td>
									  </tr>
								<?php
									}
