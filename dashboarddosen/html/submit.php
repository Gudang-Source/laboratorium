        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                           <a class="profile-pic" href="#"> <img src="../plugins/images/User_man_male_profile_account_person_people.png" alt="user-img" width="36" class="img-circle"><b id="welcome">Welcome <i></i></b></a>
                    </li>
					<li>
